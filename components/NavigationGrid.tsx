    ...
    >
      <style>
        {`
          ...
          .group:hover .mat-path {
            stroke-dashoffset: 0;
          }
          .hero-active .mat-path {
            stroke-dashoffset: 0;
          }
        `}
      </style>
    ...
    >
      <style>
        {`
          ...
          .group:hover .iso-path {
            stroke-dashoffset: 0;
          }
          .hero-active .iso-path {
            stroke-dashoffset: 0;
          }
        `}
      </style>
...
const NavigationGrid: React.FC<NavigationGridProps> = ({ items, onNavigate }) => {
  ...
  return (
    <section className="h-screen max-h-screen w-full bg-transparent flex flex-col justify-center items-center px-4 md:px-8 relative overflow-hidden selection:bg-[#751E19] selection:text-white">
      ...
      <div className="absolute inset-0 opacity-[0.04] noise-overlay mix-blend-multiply" />
              ...
              >
                ...
                <div className="relative z-20 mt-auto pt-4 w-full">
                  <motion.h3
                    ...
                    className="font-thrift text-4xl md:text-5xl lg:text-6xl uppercase leading-[0.85] tracking-tighter transition-transform duration-500 group-hover:translate-x-2 origin-bottom-left"
                  >
                    {item}
                  </motion.h3>
                </div>
